...
def row_and_seat_dict(chart):
    ...
    for row in chart:
        ...
        for seat in row:
            #sa = row_and_seat(chart, seat_count)
            seat_dict[seat_count] = seat
            seat_count += 1
...
def nsu_cont (chart, tuple_chart, seat_address):
...
def nsd_cont (chart, tuple_chart, seat_address):
...
def nsl_cont (chart, tuple_chart, seat_address):
...
def nsr_cont (chart, tuple_chart, seat_address):
...
def nsdr_cont (chart, tuple_chart, seat_address):
...
def nsdl_cont (chart, tuple_chart, seat_address):
...
def nsul_cont (chart, tuple_chart, seat_address):
...
def shuffle_seats(chart, tuple_chart):
    ...
    seat_num_dict = assign_seat_nums(chart)
    new_sc = []
            ...
            if seat == '.':
                ...
                if row_num == 1:
                    ...
                    if seat_num == 1:
                        ...
                        nbrs = [nsr_cont(chart, tuple_chart, seat_count), nsd_cont(chart, tuple_chart, seat_count), nsdr_cont(chart, tuple_chart, seat_count)]
                        nbr_count = 0
                        for nbr in nbrs:
                            check = seat_num_dict[nbr]
                            # print(f"check: {check}")
                            nbr_count += check
                    # right-most seat
                    elif seat_num == spr:
                        ...
                        nbrs = [nsl_cont(chart, tuple_chart, seat_count), nsd_cont(chart, tuple_chart, seat_count), nsdl_cont(chart, tuple_chart, seat_count)]
                        nbr_count = 0
                        for nbr in nbrs:
                            check = seat_num_dict[nbr]
                            # print(f"check: {check}")
                    ...
                    # all middle seats
                        ...
                        nbrs = [nsl_cont(chart, tuple_chart, seat_count), nsr_cont(chart, tuple_chart, seat_count), nsdl_cont(chart, tuple_chart, seat_count), nsd_cont(chart, tuple_chart, seat_count), nsdr_cont(chart, tuple_chart, seat_count)]
                        nbr_count = 0
                        for nbr in nbrs:
                            check = seat_num_dict[nbr]
                            # print(f"check: {check}")
                ...
                # last row
                    ...
                    if seat_num == 1:
                        ...
                        nbrs = [nsu_cont(chart, tuple_chart, seat_count), nsr_cont(chart, tuple_chart, seat_count), nsur_cont(chart, tuple_chart, seat_count)]
                        nbr_count = 0
                        for nbr in nbrs:
                            check = seat_num_dict[nbr]
                            # print(f"check: {check}")
                    ...
                    # right-most seat
                        ...
                        nbrs = [nsl_cont(chart, tuple_chart, seat_count), nsu_cont(chart, tuple_chart, seat_count), nsul_cont(chart, tuple_chart, seat_count)]
                        nbr_count = 0
                        for nbr in nbrs:
                            check = seat_num_dict[nbr]
                            # print(f"check: {check}")
                    ...
                    # all middle seats
                        ...
                        nbrs = [nsl_cont(chart, tuple_chart, seat_count), nsr_cont(chart, tuple_chart, seat_count), nsul_cont(chart, tuple_chart, seat_count), nsu_cont(chart, tuple_chart, seat_count), nsur_cont(chart, tuple_chart, seat_count)]
                        nbr_count = 0
                        for nbr in nbrs:
                ...
                # all other rows
                    ...
                    if seat_num == 1:
                        ...
                        nbrs = [nsu_cont(chart, tuple_chart, seat_count), nsur_cont(chart, tuple_chart, seat_count), nsr_cont(chart, tuple_chart, seat_count), nsdr_cont(chart, tuple_chart, seat_count), nsd_cont(chart, tuple_chart, seat_count)]
                        nbr_count = 0
                        for nbr in nbrs:
                            check = seat_num_dict[nbr]
                            # print(f"check: {check}")
                    ...
                    # right-most seat
                        ...
                        nbrs = [nsu_cont(chart, tuple_chart, seat_count), nsul_cont(chart, tuple_chart, seat_count), nsl_cont(chart, tuple_chart, seat_count), nsdl_cont(chart, tuple_chart, seat_count), nsd_cont(chart, tuple_chart, seat_count)]
                        nbr_count = 0
                        for nbr in nbrs:
                            check = seat_num_dict[nbr]
                            # print(f"check: {check}")
                    ...
                    # all middle seats
                        ...
                        nbrs = [nsul_cont(chart, tuple_chart, seat_count), nsu_cont(chart, tuple_chart, seat_count), nsur_cont(chart, tuple_chart, seat_count), nsr_cont(chart, tuple_chart, seat_count), nsdr_cont(chart, tuple_chart, seat_count), nsd_cont(chart, tuple_chart, seat_count), nsdl_cont(chart, tuple_chart, seat_count), nsl_cont(chart, tuple_chart, seat_count)]
                        nbr_count = 0
                        for nbr in nbrs:
                            check = seat_num_dict[nbr]
                            # print(f"check: {check}")
...
sc_tuple = row_and_seat_dict(sc)

   
counter = 0
keep_shuffling = True

# calls the shuffle function to create a new seat map, and doesn't stop until it eaches
...
while counter < 500 and keep_shuffling == True:
    ...
    counter+= 1
    new_sc = shuffle_seats(sc, sc_tuple)
    ...
    if new_sc == sc:
        ...
        print(f"\n\t{seats_occ} seats are occupied after {counter} rounds of shuffling.")
    

        

    
    sc = shuffle_seats(sc, sc_tuple)
